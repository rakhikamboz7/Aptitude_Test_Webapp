        ...
        <div className="flex-1 text-center lg:text-left space-y-8">
          ...
          <div className="flex items-center justify-center lg:justify-start space-x-4">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-sky-400 rounded-2xl blur-lg opacity-40" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-4">
            {[
              { icon: Building2, title: "Company-Specific Tests",  desc: "Practice with tailored assessments for 7+ top companies"      },
              { icon: Sparkles,  title: "AI-Powered Feedback",     desc: "Get personalized insights and improvement strategies"          },
              { icon: Award,     title: "Achievement Badges",      desc: "Earn badges as you progress through skill levels"              },
              { icon: TrendingUp,title: "Progress Tracking",       desc: "Monitor your improvement with detailed analytics"              },
            ].map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="flex items-start space-x-4 p-5 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 group"
              >
                <div className="p-2.5 bg-blue-50 rounded-xl group-hover:bg-blue-100 transition-colors flex-shrink-0">
