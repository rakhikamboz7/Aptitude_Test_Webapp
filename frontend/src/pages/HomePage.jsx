...
// ✅ Session flag — loading plays only once per browser session
let initialLoadDone = false

export default function HomePage() {
  const navigate = useNavigate()
  const { user } = useAuth() // logout handled by Navigation component
  ...
  // ✅ companiesList as state so custom companies can be added as pills
  ...
  // ✅ Save custom company as a new pill + select it
  ...
  // ✅ One-time loading animation per session
  useEffect(() => {
    ...
    return (
      <div className="fixed inset-0 bg-slate-50 flex items-center justify-center overflow-hidden">
        <svg className="absolute inset-0 w-full h-full opacity-10" xmlns="http://www.w3.org/2000/svg">
          ...
          {[...Array(5)].map((_, i) => (
            <circle key={i} cx={`${20 + i * 15}%`} cy="50%" r="100" fill="url(#grad1)" opacity="0.15"
              style={{ animation: `pulse ${2 + i * 0.5}s ease-in-out infinite`, animationDelay: `${i * 0.2}s` }} />
          ))}
          <path d="M0,50 Q250,100 500,50 T1000,50" stroke="url(#grad1)" strokeWidth="2" fill="none" opacity="0.2"
        ...
        <div className="relative z-10 text-center">
          <div className="mb-8 relative">
            <div className="w-32 h-32 mx-auto relative">
              <svg viewBox="0 0 100 100" className="w-full h-full">
                ...
                <circle cx="50" cy="50" r="45" fill="none" stroke="url(#brainGrad)" strokeWidth="3"
          ...
          {/* ✅ Light theme: text-slate-900 (not white) */}
          <h1 className="text-5xl font-bold text-slate-900 mb-4 animate-fade-in">
            Aptitude<span className="text-sky-500">AI</span>
          </h1>
          <p className="text-slate-600 text-lg mb-8 animate-fade-in" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="w-80 mx-auto">
            <div className="bg-slate-200 rounded-full h-2 overflow-hidden border border-slate-300">
              <div className="h-full bg-gradient-to-r from-sky-400 to-blue-500 transition-all duration-300 ease-out relative"
          ...
          <div className="flex justify-center gap-2 mt-8">
            {[0, 1, 2].map((i) => (
              <div key={i} className="w-2.5 h-2.5 bg-sky-500 rounded-full animate-bounce"
    ...
    <div className="min-h-screen bg-slate-50 relative overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-sky-300/30 to-blue-400/30 rounded-full blur-3xl"
          style={{ transform: `translate(${-mousePosition.x}px, ${-mousePosition.y}px)`, transition: "transform 0.5s ease-out" }} />
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-br from-indigo-300/20 to-blue-300/20 rounded-full blur-3xl"
          style={{ transform: `translate(-50%, -50%) translate(${mousePosition.x * 0.5}px, ${mousePosition.y * 0.5}px)`, transition: "transform 0.5s ease-out" }} />
      </div>

      {/* ✅ Navigation component (handles header + mobile menu + logout) */}
      <Navigation />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="relative mb-8 mt-8">
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-slate-900 mb-6 animate-fade-in leading-tight">
                Professional Career
                <br />
                <span className="relative inline-block">
                  ...
                  <svg className="absolute -bottom-2 left-0 w-full opacity-60" height="12" viewBox="0 0 300 12" fill="none">
                    <path d="M2 10C50 5 100 2 150 2C200 2 250 5 298 10" stroke="url(#underlineGrad)" strokeWidth="4"
                      strokeLinecap="round"
                      style={{ strokeDasharray: 300, strokeDashoffset: 300, animation: "drawLine 1.5s ease-out 0.5s forwards" }} />
                    <defs>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl p-6 shadow-xl shadow-slate-200/50">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
                ...
                <div className="relative w-full md:w-80">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-full text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all text-sm shadow-inner"
                  />
                </div>
              </div>
                ...
                {filteredCompanies.map((company) => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setCustomCompany("")
                      setShowCustomInput(false)
                      // ✅ Smart scroll to difficulty section
                      setTimeout(() => {
                        difficultySectionRef.current?.scrollIntoView({ behavior: "smooth", block: "center" })
                      }, 100)
                    }}
                    className={`flex-shrink-0 px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 flex items-center gap-2 border ${
                      selectedCompany === company.id
                        ? "bg-gradient-to-r from-blue-600 to-sky-500 text-white border-transparent shadow-md shadow-blue-500/30"
              ...
              {/* ✅ Custom input (light theme) with Confirm button + pill creation */}
              {showCustomInput && (
                  ...
                  <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
                    ...
                    <div className="flex gap-3">
                      <input
                        ...
                        placeholder="Enter company name (e.g., Tesla, Goldman Sachs)..."
          ...
          {/* ─── Gemini-Powered Intelligence Card (light theme) ───────────────── */}
          <div className="mb-24 max-w-5xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="bg-white/80 backdrop-blur-xl border border-slate-200 rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 flex flex-col lg:flex-row-reverse">
              <div className="p-8 lg:p-10 lg:w-1/2 flex flex-col justify-center relative">
                ...
                <Badge className="w-fit mb-4 bg-purple-100 text-purple-700 border-purple-200 px-3 py-1 font-semibold tracking-wide text-[10px]">
                  Simple & Powerful
                </Badge>
                <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 mb-4">Gemini-Powered Intelligence</h2>
                <p className="text-base text-slate-600 mb-8 leading-relaxed">
                  To ensure the highest standard of evaluation, our platform is built directly on Google Gemini. By leveraging its native intelligence, we guarantee world-class reasoning quality and precise feedback for every assessment.
                </p>
                <div className="space-y-6 mb-8">
                  {[
                    { title: "Dynamic Gemini Reasoning",    desc: "Leverage the native logic and semantic understanding of Google Gemini to analyze your complex answers without middle-ware interference." },
                    { title: "Personalized Gemini Roadmap", desc: "Receive a learning plan synthesized directly from Gemini's analysis of your cognitive gaps in real-time." },
                  ].map(({ title, desc }) => (
                  ...
                  <div className="p-5 lg:p-6 space-y-6">
                    <div>
                      ...
                      <div className="w-full bg-slate-100 rounded-full h-1.5">
                        <div className="bg-purple-500 h-1.5 rounded-full relative shadow-sm" style={{ width: "92%" }}>
                    ...
                    <div>
                      <div className="flex justify-between text-xs mb-2.5">
                        <span className="text-slate-800 font-bold">Logical Deduction Speed</span>
                        <span className="text-indigo-600 font-bold">64%</span>
                      </div>
                      <div className="w-full bg-slate-100 rounded-full h-1.5">
                        <div className="bg-indigo-500 h-1.5 rounded-full relative shadow-sm" style={{ width: "64%" }}>
                          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1.5 h-1.5 bg-white rounded-full shadow-sm" />
                        </div>
                      </div>
                      <p className="text-[10px] text-slate-500 mt-2.5 flex items-center gap-1.5 font-medium">
          ...
          {/* ─── Question of the Day Card (light theme) ───────────────────────── */}
          <div className="mb-8 max-w-5xl mx-auto animate-fade-in">
            ...
            <div className="bg-white/80 backdrop-blur-xl border border-slate-200 rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 flex flex-col lg:flex-row">
              <div className="p-8 pt-12 lg:p-10 lg:w-1/2 flex flex-col justify-start relative">
                ...
                <Badge className="w-fit mb-4 bg-indigo-100 text-indigo-700 border-indigo-200 px-3 py-1 font-semibold tracking-wide text-[10px]">
                  QUESTION OF THE DAY
                </Badge>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <Button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-4 h-auto rounded-xl text-sm font-semibold shadow-md shadow-indigo-500/20 transition-all duration-300">
                    Try This Question
                  </Button>
                  <Button variant="ghost" className="text-slate-600 hover:text-slate-900 hover:bg-slate-100 px-4 py-4 h-auto rounded-xl text-sm font-semibold transition-all duration-300">
                    Explain Solution
                  </Button>
                </div>
              </div>

              {/* ✅ Light theme question panel */}
              <div className="p-6 lg:p-8 lg:w-1/2 bg-slate-50/50 border-l border-slate-200 flex items-center justify-center relative">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 lg:p-6 w-full max-w-md shadow-xl shadow-slate-200/80 transform transition-transform hover:scale-[1.02] duration-500">
                  <div className="flex justify-between items-center mb-5">
                    <span className="text-[10px] font-bold tracking-wider text-slate-500 uppercase">Question #204 - Numerical</span>
                    <Badge variant="outline" className="text-slate-600 border-slate-300 bg-slate-50 text-[10px] px-2 py-0">Hard</Badge>
                  </div>
                  <p className="text-slate-900 text-sm mb-6 leading-relaxed font-bold">
                  ...
                  <div className="space-y-2">
                    {["4.25%", "6.70%", "12.4%", "8.10%"].map((opt, i) => {
                      ...
                      return (
                        ...
                        >
                          <span className={`text-sm font-bold transition-colors ${isSelected ? "text-indigo-900" : "text-slate-600 group-hover:text-slate-900"}`}>
                            {opt}
                          </span>
                          <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center bg-white transition-colors ${isSelected ? "border-indigo-500" : "border-slate-300 group-hover:border-indigo-400"}`}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-blue-600 to-sky-500 rounded-xl shadow-md">
                <Brain className="h-6 w-6 text-white" />
              </div>
              <div>
                <span className="text-xl font-bold text-slate-900">Aptitude<span className="text-sky-500">AI</span></span>
                <p className="text-sm text-slate-500 font-medium">Professional Career Development</p>
              </div>
            </div>
